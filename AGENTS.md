...
Este repositório contém a biblioteca `enginefx:enginefx:3.0.0`. O jogo consumidor está no checkout irmão `dinofx`. Leia [README.md](README.md), [BluePrint.md](BluePrint.md) e [PRD.md](PRD.md). [REVIEW.md](REVIEW.md) registra a validação histórica; a auditoria original está em [VULKAN_MIGRATION_REVIEW.md](VULKAN_MIGRATION_REVIEW.md).
