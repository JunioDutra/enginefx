...
/** Shaderc adapter compiled only by the shader-tools Maven profile. */
final class LwjglVulkanShaderCompiler
{
    static ByteBuffer compileShader(String source, int kind, String name)
    {
